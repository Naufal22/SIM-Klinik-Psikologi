...
requireRole(ROLE_MASTER);
checkSessionTimeout();

$title = "Master Data - Manajemen Akun Pasien";
$activePage = 'master-data-pasien';
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manajemen Akun Pasien</h3>
                    <p class="text-subtitle text-muted">Kelola data akun pasien</p>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title">Data Akun Pasien</h5>
                        <a href="add-pasien.php" class="btn btn-primary">
                            <i class="bi bi-plus"></i> Tambah Akun Pasien
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <table class="table table-striped" id="table-accounts">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM users WHERE role = 'pasien' ORDER BY created_at DESC";
