...
<head>
    ...
    <link
        ...
        type="image/png" />
    <link rel="stylesheet" crossorigin href="<?= $main_url ?>_dist/assets/compiled/css/app.css">
    <link rel="stylesheet" crossorigin href="<?= $main_url ?>_dist/assets/compiled/css/app-dark.css">
    <link rel="stylesheet" crossorigin href="<?= $main_url ?>_dist/assets/compiled/css/app-dark.css">
    <!-- Di bagian head, setelah CSS lainnya -->
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.php"><span class="logo-text">Assyifa</span>
                        </div>
